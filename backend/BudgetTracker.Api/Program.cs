...
Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", "google-vision-service-account.json");
...
builder.Services.AddScoped<DocumentAiReceiptParser>();
