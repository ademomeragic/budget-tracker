...
export default function Wallet() {
  ...
  const convertedBalance = selectedWallet ? selectedWallet.balance * conversionRate : 0;
      ...
      <div className="balance-section">
        ...
        {selectedWallet && (
          <div className="balance-display">
            <p className={`balance-amount ${selectedWallet.balance >= 0 ? "positive" : "negative"}`}>
            ...
            <div className="wallet-actions">
              <button onClick={() => handleEditWallet(selectedWallet)}><EditIcon /></button>
              <button onClick={() => handleDeleteWallet(selectedWallet.id)}><TrashIcon /></button>
            </div>
          </div>
        )}
      </div>
