    ...
    <div className="goals-page">
      ...
      <div className="goal-form">
        ...
        <small className="currency-hint">
          Target amount must be entered in <strong>BAM</strong> (Bosnian Convertible Mark)
        </small>
        <input
          type="date"
      ...
      <ul className="goal-list">
        {filteredGoals.map((goal) => (
          <li key={goal.id} className="goal-item">
            ...
            {formatCurrency(goal.convertedCurrent ?? goal.currentAmount, goal.currency ?? "KM")} /{" "}
            {formatCurrency(goal.convertedTarget ?? goal.targetAmount, goal.currency ?? "KM")}
